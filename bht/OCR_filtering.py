...
def ocr_filter(current_OCR_folder):
    ...
    content = re.sub(r"([0-9]{2})([0-9]{2})((-|–|—)|(-|–|—) | (-|–|—)| (-|–|—) | to | and )([0-9]{2})([0-9]{2})",
                     r"\1:\2 - \8:\9", content)
    ...
    content = re.sub(r"([0-9]{2}\:[0-9]{2})(\-|\–|\—)([0-9]{2}\:[0-9]{2})", r"\1 \2 \3",
                     content)  # replace "09:30-23:30" by "09:30 - 23:30"
    content = re.sub(r"([0-9]{2}\:[0-9]{2})(\-|\–|\—) ([0-9]{2}\:[0-9]{2})", r"\1 \2 \3",
                     content)  # replace "09:30- 23:30" by "09:30 - 23:30"
    content = re.sub(r"([0-9]{2}\:[0-9]{2}) (\-|\–|\—)([0-9]{2}\:[0-9]{2})", r"\1 \2 \3",
                     content)  # replace "09:30 -23:30" by "09:30 - 23:30"
    content = re.sub(r"([0-9]{2}\:[0-9]{2}\:[0-9]{2}\.[0-9]{1,3})", r"T\1",
                     content)  # replace "10:28:42.950" by "T10:28:42.950"
    content = re.sub(
    ...
    content = re.sub(
        ...
        content)  # replace "2018 Oct 9 12:00 2018 Oct 11 00:00" by "9 Oct 2018 at 12:00 to 11 Oct 2018 at 00:00 "
